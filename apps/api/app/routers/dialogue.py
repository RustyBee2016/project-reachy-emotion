...
def _build_lm_studio_prompt(
    ...
    emotion_guidance = {
        ...
        "angry": "The user appears frustrated or angry. Respond calmly and with understanding. Acknowledge their feelings and offer to help.",
        "neutral": "The user appears calm and neutral. Respond in a balanced, friendly tone.",
        "surprise": "The user appears surprised. Respond with curiosity and engagement.",
        "fearful": "The user appears anxious or fearful. Respond with reassurance and calm support.",
    }
...
def _extract_gesture_cue(emotion: str, confidence: float) -> str:
    ...
    gesture_map = {
        ...
        "surprise": "head_tilt_curious",
        "fearful": "open_hands_reassuring",
    }
