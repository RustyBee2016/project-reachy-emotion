...
def generate_demo_fold_metrics(
    ...
    if effect_pattern == "none":
        ...
        effects = {
            "anger": 0.02,
            "contempt": 0.08,    # Large improvement (underrepresented class)
            "disgust": 0.06,    # Moderate improvement
            "fear": 0.03,
            "happiness": -0.02,  # Slight degradation
            "neutral": 0.04,    # Moderate improvement (important for Phase 2)
            "sadness": 0.01,
            "surprise": 0.02,
        }
